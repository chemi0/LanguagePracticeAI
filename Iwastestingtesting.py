...
class ChatApp:
    ...
    def add_ai_message(self, message):
        ...
        self.conversation_display.tag_bind(ai_label_tag, '<Button-1>', lambda event, text=message: speak_response(text, self.language))
        ...
        self.conversation_display.insert(tk.END, message + "\n", ai_tag)
        self.conversation_display.tag_bind(ai_tag, '<Motion>', lambda event, text=message: self.show_translation_popup(event, text, ai_tag))
        self.conversation_display.tag_bind(ai_tag, '<Button-1>', lambda event, text=message: self.show_gemini_explanation_popup(event, text))
